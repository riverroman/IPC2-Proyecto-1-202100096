...
class ListaSenal:
    ...
    def imprimir_listaSenal(self):
        ...
        actual = self.cabeza
        while actual != None:
            print('Nombre:', actual.senal.nombre, 'Tiempo:',
                actual.senal.tiempo, 'Amplitud:', actual.senal.amplitud)
    ...
    def calcular_los_patrones(self, nombre_senal):
        ...
        while actual != None:
            ...
            if actual.senal.nombre == nombre_senal:
                ...
                actual.senal.lista_patrones_nivel = actual.senal.lista_datos_patrones.devolver_patrones_por_nivel(
                    actual.senal.lista_patrones_nivel)
                ...
                for digito in grupos_sin_analizar:
                    ...
                    if digito.isdigit() or digito == ",":
                        ...
                        cadena_grupo = actual.senal.lista_datos.devolver_cadena_por_grupo(
                            buffer)
                        actual.senal.lista_grupos.agregar(
                            grupo=grupo(buffer, cadena_grupo))
    ...
    def generar_xml_salida(self):
        ...
        while actual != None:
            ...
            nombre_amplitud = ET.SubElement(senal, 'senalnombre')
            nombre_amplitud.text = f'Nombre = {actual.senal.nombre} Amplitud = {actual.senal.amplitud}'
            nombre_amplitud.text = nombre_amplitud.text
            ...
            lista_patrones = ET.SubElement(senal, 'dato')

            while actual_lista_patrones != None:
                
                valor = ET.SubElement(lista_patrones, 'dato')
            ...
            arbol_xml.write("./Xml/salida.xml",
